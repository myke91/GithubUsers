 ...
 */
public abstract class Hilt_GithubUserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GithubUserFragment() {
    super();
  }

  Hilt_GithubUserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GithubUserFragment_GeneratedInjector) this.generatedComponent()).injectGithubUserFragment(UnsafeCasts.<GithubUserFragment>unsafeCast(this));
    }
  }
