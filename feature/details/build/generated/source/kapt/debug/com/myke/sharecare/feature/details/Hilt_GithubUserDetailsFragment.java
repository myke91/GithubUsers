 ...
 */
public abstract class Hilt_GithubUserDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GithubUserDetailsFragment() {
    super();
  }

  Hilt_GithubUserDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GithubUserDetailsFragment_GeneratedInjector) this.generatedComponent()).injectGithubUserDetailsFragment(UnsafeCasts.<GithubUserDetailsFragment>unsafeCast(this));
    }
  }
